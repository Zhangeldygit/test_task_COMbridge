...
mixin _$StateBlocPersons {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Person> data, bool isLoading, String? errorMessage)
        data,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<Person> data, bool isLoading, String? errorMessage)?
        data,
...
abstract class _$$StatePersonsDataCopyWith<$Res> {
  ...
  $Res call({List<Person> data, bool isLoading, String? errorMessage});
}
...
class _$StatePersonsData implements StatePersonsData {
  ...
  @override
  String toString() {
    return 'StateBlocPersons.data(data: $data, isLoading: $isLoading, errorMessage: $errorMessage)';
  }
...
abstract class StatePersonsData implements StateBlocPersons {
  const factory StatePersonsData(
      {required final List<Person> data,
      final bool isLoading,
      final String? errorMessage}) = _$StatePersonsData;
